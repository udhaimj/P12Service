...
namespace P12StatefulService
{
    ...
    /// </summary>
    internal sealed class P12StatefulService : StatefulService
    {
        public P12StatefulService(StatefulServiceContext context)
            : base(context)
        { }
        ...
        protected override async Task RunAsync(CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                //Add log to file notepad for future use
